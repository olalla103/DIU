...
public class Reserva {
    ...
    private com.example.gestionhotelfran.modelo.repository.impl.tipoHabitacion tipoHabitacion; // Cambiado a StringProperty
    private BooleanProperty fumador;
    private com.example.gestionhotelfran.modelo.repository.impl.regimenAlojamiento regimenAlojamiento; // Cambiado a StringProperty
    ...
    public com.example.gestionhotelfran.modelo.repository.impl.tipoHabitacion gettipoHabitacion() {
    ...
    public com.example.gestionhotelfran.modelo.repository.impl.regimenAlojamiento getregimenAlojamiento() {
